const ON_THE_ROCKS = [
    ...
    "Is there anyone I’m I friends with anyone you can’t fully endorse? Is there anything you think I should consider about them?",
    ...
    "Tell us about your last breakup talk. Who said what? nything you wish you’d said?",
    ...
    "If someone offered you $50,000 to never talk to me again, would you?",
    ...
    "What’s something you’re still self-conscious about? re you working on it?",
...
const EXTRA_DIRTY = [
    "Where’s the strangest place you’ve had sex?What’s the sex skill you’re most proud of?Describe your sex life with a movie title, and tell us your reasoning.",
    ...
    "Have I ever popped into your head while you were masturbating? Will it happen now that we’ve asked the question? Who do you think has had more sexual partners, you or me?",
...
const HAPPY_HOUR = [
    ...
    "Fill in the blank. Defend yourself: I don’t care if ___ is for kids, I will still love it until I die.",
    "Do you try to always be honest with me, or do you tell me “that haircut looks great”-level white lies to be nice?What’s the best zinger you’ve ever come up with on the fly? I know you remember it.",
    "What are the farthest lengths you’ve gone to to cheer someone up?What’s the the most courageous thing you’ve ever accomplished?",
    ...
    "What’s the most consid- erate present you’ve ever received? Given?",
    ...
    "Describe the dream vacation you haven’t gotten to take.",
    "Then tell me how you can make it happen in five years or less.",
    ...
    "Show me the funniest thing on the internet under 30 seconds long. If I laugh, I drink.We’re binging tonight!",
    "Pick the show and the snack.What song reminds you of me whenever you hear it?",
    ...
    "Would you trust me to pierce your ear, 80’s-sleepover style?I’m going to have permanent art deposited into my skin with needles. Pick a design for me. Bonus points if you draw it.",
    ...
    "What was your first impression of me? Has it turned out to be the case?What’s the hold music for your brain?",
    ...
    "If we were flying some- where together, who would volunteer to sit in the middle seat?What did you think you would hate, but ended up loving?",
    ...
    "Tell me about a disagree- ment we had—and how we resolved it. Has it made us stronger?",
...
const selectRandomQuestion = (categoryName, i = 0) => {
    switch(categoryName) {
        case 'EXTRA_DIRTY':
            return pickRandomQuestion(EXTRA_DIRTY);
        case 'HAPPY_HOUR':
            return pickRandomQuestion(HAPPY_HOUR);
        case 'LAST_CALL':
            return pickRandomQuestion(LAST_CALL);
        case 'ON_THE_ROCKS':
            return pickRandomQuestion(ON_THE_ROCKS);
    }
}

const pickRandomQuestion = (questionBank)  => questionBank[Math.floor(Math.random() * questionBank.length)];
